            ...
            <div className="w-full max-w-[1120px] flex flex-col mx-auto pb-12 px-4">
                ...
                <div className="w-full h-full flex flex-col mt-8">
                    ...
                    <div className="flex w-full flex-col mt-4 sm:mt-8">
                        ...
                        {/* Título */}
                        <h1 className="font-bold text-2xl sm:text-4xl lg:text-[40px] text-white">{post.title}</h1>
                        ...
                        {/* Bloco do conteúdo do artigo */}
                        <div className="mt-4 sm:mt-8">

                            {/* Conteúdo do artigo */}
                            <RichText
                                renderers={{
                                    p: ({ children }) => <p className="text-white text-sm sm:text-base text-justify lg:text-left mt-4">{children}</p>
                                }}
...
//Renderização do conteúdo do artigo para o Front-End
